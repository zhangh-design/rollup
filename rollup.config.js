...
// import { terser } from "rollup-plugin-terser"; // js代码检测

export default {
  input: ["./src/index.js"], // 包的入口点
  output: {
    file: "./dist/bundle.js", // 要写入的文件
    /**
     * @desc 生成包的格式
    ...
    format: "umd",
    /**
     * @desc 生成包名称，变量名，代表你的 iife/umd 包，同一页上的其他脚本可以访问它。
     */
    name: "experience", // 打包后文件的全局变量，在引入的代码中使用这个名字就可以调用这个js文件中的方法了
  ...
  plugins: [
    ...
    babel({
      babelHelpers: "runtime", // 配合 `` https://github.com/rollup/plugins/tree/master/packages/babel#babelhelpers
